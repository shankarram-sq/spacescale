...
export const ORGANISATION_ADMIN_CSS = `
  ...
  .ssa-admin { box-sizing: border-box; width: min(1440px, 100%); min-height: 100%; margin: 0 auto; padding: 32px; font: 15px/1.5 Inter, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; }
